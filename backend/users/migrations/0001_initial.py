# Generated by Django 3.2 on 2023-12-26 19:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Введите адрес электронной почты.', max_length=200, unique=True, verbose_name='Email')),
                ('username', models.CharField(help_text='Введите ник пользователя', max_length=100, unique=True, validators=[api.validators.validate_username], verbose_name='Ник')),
                ('first_name', models.CharField(help_text='Введите свое имя', max_length=100, verbose_name='Имя')),
                ('last_name', models.CharField(help_text='Введите свою фамилию', max_length=100, verbose_name='Фамилия')),
